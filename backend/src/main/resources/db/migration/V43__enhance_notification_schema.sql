...
CREATE INDEX IF NOT EXISTS idx_ian_created_at ON in_app_notifications(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_ian_priority ON in_app_notifications(priority);
CREATE INDEX IF NOT EXISTS idx_ian_category ON in_app_notifications(category);
...
CREATE INDEX IF NOT EXISTS idx_edl_notification_event ON email_delivery_logs(notification_event_id);
CREATE INDEX IF NOT EXISTS idx_edl_recipient_email ON email_delivery_logs(recipient_email);
CREATE INDEX IF NOT EXISTS idx_edl_status ON email_delivery_logs(status);
CREATE INDEX IF NOT EXISTS idx_edl_sent_at ON email_delivery_logs(sent_at DESC);
