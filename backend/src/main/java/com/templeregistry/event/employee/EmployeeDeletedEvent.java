...
/**
 * Event fired when a Temple Authority removes an employee.
 * Notifies the District Collector.
 */
@Getter
public class EmployeeDeletedEvent extends BaseNotificationEvent {
    ...
    public EmployeeDeletedEvent(
        ...
        super(source, employeeId, "EMPLOYEE", deletedByUserId, UserRole.TEMPLE_AUTHORITY,
    ...
    public String getNotificationBody() {
        return String.format("Employee '%s' (%s) has been removed from %s", 
