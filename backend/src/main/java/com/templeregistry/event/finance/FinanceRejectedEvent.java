...
@Getter
public class FinanceRejectedEvent extends BaseNotificationEvent {
    private final String trustName;
    private final String financialYear;
    private final Long templeAuthorityId;

    public FinanceRejectedEvent(Object source, Long trustId, String trustName,
    ...
    @Override public String getNotificationTitle() { return "Financial Statement Rejected"; }
    @Override public String getNotificationBody() {
        return String.format("Financial statement for %s (FY %s) has been rejected.", trustName, financialYear);
    }
